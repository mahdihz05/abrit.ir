...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_content_blocks_hero_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_rich_text_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_feature_grid_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_faq_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_testimonials_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_cta_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_content_section_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum_content_blocks_content_section_section_type" AS ENUM('hero', 'rich_text', 'service_grid', 'solution_grid', 'pricing', 'feature_grid', 'logo_cloud', 'testimonials', 'faq', 'cta');
  ...
  CREATE TYPE "public"."enum__content_v_blocks_hero_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_rich_text_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_feature_grid_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_faq_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_testimonials_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_cta_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_content_section_variant" AS ENUM('default', 'simple', 'centered', 'split', 'dashboard', 'network', 'cards', 'bento', 'compact');
  CREATE TYPE "public"."enum__content_v_blocks_content_section_section_type" AS ENUM('hero', 'rich_text', 'service_grid', 'solution_grid', 'pricing', 'feature_grid', 'logo_cloud', 'testimonials', 'faq', 'cta');
  ...
  CREATE TYPE "public"."enum_packages_term_prices_cycle" AS ENUM('monthly', 'quarterly', 'semiannually', 'annually');
  ...
  CREATE TYPE "public"."enum_form_submissions_locale" AS ENUM('fa', 'en', 'ar-ae');
  ...
  CREATE TABLE "content_blocks_content_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"enabled" boolean DEFAULT true,
  	"variant" "enum_content_blocks_content_section_variant" DEFAULT 'default',
  	"section_type" "enum_content_blocks_content_section_section_type",
  	"content" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "content_capabilities_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "_content_v_blocks_content_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"enabled" boolean DEFAULT true,
  	"variant" "enum__content_v_blocks_content_section_variant" DEFAULT 'default',
  	"section_type" "enum__content_v_blocks_content_section_section_type",
  	"content" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_content_v_version_capabilities" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar
  ...
  CREATE TABLE "_content_v_version_capabilities_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_content_v_version_technologies" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "packages_term_prices" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"cycle" "enum_packages_term_prices_cycle" NOT NULL,
  	"months" numeric NOT NULL,
  	"total_toman" numeric NOT NULL,
  	"discount_bps" numeric DEFAULT 0,
  	"onboarding_bps" numeric DEFAULT 0
  );
  ...
  CREATE TABLE "packages" (
  	...
  	"base_monthly_toman" numeric NOT NULL,
  	"included_users" numeric NOT NULL,
  	"max_extra_users" numeric DEFAULT 0,
  	"included_endpoints" numeric NOT NULL,
  	"included_servers" numeric DEFAULT 0,
  	"included_sites" numeric DEFAULT 1,
  	"extra_user_monthly_toman" numeric DEFAULT 0,
  	"extra_endpoint_monthly_toman" numeric DEFAULT 0,
  	"currency" varchar DEFAULT 'IRT' NOT NULL,
  	"is_featured" boolean DEFAULT false,
  	"is_active" boolean DEFAULT true,
  	"whmcs_product_id" numeric,
  	"whmcs_extra_user_option_id" numeric,
  	"whmcs_extra_endpoint_option_id" numeric,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "site_settings" (
  	...
  	"logo_id" integer,
  	"favicon_id" integer,
  	"phone" varchar DEFAULT '05131881000',
  	"email" varchar,
  ...
  CREATE TABLE "_site_settings_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"version_brand_name" varchar DEFAULT 'AbrIT' NOT NULL,
  	"version_logo_id" integer,
  	"version_favicon_id" integer,
  	"version_phone" varchar DEFAULT '05131881000',
  ...
  CREATE TABLE "_product_catalog_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"version_catalog" jsonb NOT NULL,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  ALTER TABLE "content_blocks_content_section" ADD CONSTRAINT "content_blocks_content_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "content_capabilities" ADD CONSTRAINT "content_capabilities_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "content_capabilities_locales" ADD CONSTRAINT "content_capabilities_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."content_capabilities"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "content_technologies" ADD CONSTRAINT "content_technologies_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."content"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_content_v_blocks_content_section" ADD CONSTRAINT "_content_v_blocks_content_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_content_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_content_v_version_capabilities" ADD CONSTRAINT "_content_v_version_capabilities_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_content_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_content_v_version_capabilities_locales" ADD CONSTRAINT "_content_v_version_capabilities_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_content_v_version_capabilities"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_content_v_version_technologies" ADD CONSTRAINT "_content_v_version_technologies_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_content_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "packages_term_prices" ADD CONSTRAINT "packages_term_prices_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."packages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "content_blocks_content_section_order_idx" ON "content_blocks_content_section" USING btree ("_order");
  CREATE INDEX "content_blocks_content_section_parent_id_idx" ON "content_blocks_content_section" USING btree ("_parent_id");
  CREATE INDEX "content_blocks_content_section_path_idx" ON "content_blocks_content_section" USING btree ("_path");
  CREATE INDEX "content_blocks_content_section_locale_idx" ON "content_blocks_content_section" USING btree ("_locale");
  CREATE INDEX "content_capabilities_order_idx" ON "content_capabilities" USING btree ("_order");
  CREATE INDEX "content_capabilities_parent_id_idx" ON "content_capabilities" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "content_capabilities_locales_locale_parent_id_unique" ON "content_capabilities_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "content_technologies_order_idx" ON "content_technologies" USING btree ("_order");
  CREATE INDEX "content_technologies_parent_id_idx" ON "content_technologies" USING btree ("_parent_id");
  ...
  CREATE INDEX "_content_v_blocks_content_section_order_idx" ON "_content_v_blocks_content_section" USING btree ("_order");
  CREATE INDEX "_content_v_blocks_content_section_parent_id_idx" ON "_content_v_blocks_content_section" USING btree ("_parent_id");
  CREATE INDEX "_content_v_blocks_content_section_path_idx" ON "_content_v_blocks_content_section" USING btree ("_path");
  CREATE INDEX "_content_v_blocks_content_section_locale_idx" ON "_content_v_blocks_content_section" USING btree ("_locale");
  CREATE INDEX "_content_v_version_capabilities_order_idx" ON "_content_v_version_capabilities" USING btree ("_order");
  CREATE INDEX "_content_v_version_capabilities_parent_id_idx" ON "_content_v_version_capabilities" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "_content_v_version_capabilities_locales_locale_parent_id_uni" ON "_content_v_version_capabilities_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "_content_v_version_technologies_order_idx" ON "_content_v_version_technologies" USING btree ("_order");
  CREATE INDEX "_content_v_version_technologies_parent_id_idx" ON "_content_v_version_technologies" USING btree ("_parent_id");
  ...
  CREATE INDEX "packages_term_prices_order_idx" ON "packages_term_prices" USING btree ("_order");
  CREATE INDEX "packages_term_prices_parent_id_idx" ON "packages_term_prices" USING btree ("_parent_id");
  ...
  CREATE UNIQUE INDEX "packages_order_idx" ON "packages" USING btree ("order");
  CREATE INDEX "packages_is_active_idx" ON "packages" USING btree ("is_active");
  ...
  CREATE INDEX "_product_catalog_v_created_at_idx" ON "_product_catalog_v" USING btree ("created_at");
  CREATE INDEX "_product_catalog_v_updated_at_idx" ON "_product_catalog_v" USING btree ("updated_at");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "content_blocks_content_section" CASCADE;
  DROP TABLE "content_capabilities" CASCADE;
  DROP TABLE "content_capabilities_locales" CASCADE;
  DROP TABLE "content_technologies" CASCADE;
  ...
  DROP TABLE "_content_v_blocks_content_section" CASCADE;
  DROP TABLE "_content_v_version_capabilities" CASCADE;
  DROP TABLE "_content_v_version_capabilities_locales" CASCADE;
  DROP TABLE "_content_v_version_technologies" CASCADE;
  DROP TABLE "_content_v" CASCADE;
  DROP TABLE "_content_v_locales" CASCADE;
  DROP TABLE "_content_v_rels" CASCADE;
  DROP TABLE "packages_term_prices" CASCADE;
  ...
  DROP TABLE "_product_catalog_v" CASCADE;
  ...
  DROP TYPE "public"."enum_content_blocks_content_section_variant";
  DROP TYPE "public"."enum_content_blocks_content_section_section_type";
  ...
  DROP TYPE "public"."enum__content_v_blocks_content_section_variant";
  DROP TYPE "public"."enum__content_v_blocks_content_section_section_type";
  ...
  DROP TYPE "public"."enum_packages_term_prices_cycle";
