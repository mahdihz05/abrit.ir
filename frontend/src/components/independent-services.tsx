...
export function IndependentServicesListing({ locale }: { locale: Locale }) {
  ...
  return (
    <main className={styles.page}>
      ...
      <IndependentConsultationForm locale={locale} />
    </main>
  );
}
...
export function IndependentServiceDetail({
  ...
  const relatedIndependent = independentServices
  ...
  return (
    <main className={styles.page} data-service={service.slug}>
      ...
      <IndependentConsultationForm locale={locale} service={service} />
    </main>
  );
}
